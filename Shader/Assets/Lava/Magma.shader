Shader "Unlit/Magma"
{
    Properties
    {
        ...
        _WaveAplitude ("Wave Amplitude", Range (0, 1)) = 0
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
                ...
                o.vertex.y += sin((-worldPos.z + (_Time.y * _WaveSpeed)) * _WaveFrequency) * _WaveAplitude;
                o.vertex.y += cos((-worldPos.x + (_Time.y * _WaveSpeed)) * _WaveFrequency) * _WaveAplitude;
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                return col;
                //return float4(i.uv.x += distortion, i.uv.y += distortion , 0, 1);
            }
            ENDCG
        }
